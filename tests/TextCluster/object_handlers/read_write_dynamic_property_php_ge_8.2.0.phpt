--TEST--
Cairo\TextCluster read_property handler - Deprecation Warning (PHP >= 8.2)
--SKIPIF--
<?php
...
Deprecated: Creation of dynamic property Cairo\TextCluster::$customProperty is deprecated in %s on line %d
string(4) "test"
