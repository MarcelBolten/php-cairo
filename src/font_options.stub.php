...
class FontOptions {
	...
	public function merge(FontOptions $other): void {}

	public function hash(): int {}

	public function equal(FontOptions $other): bool {}

	public function setAntialias(Antialias $antialias): void {}

	public function getAntialias(): Antialias {}

	public function setSubpixelOrder(SubPixelOrder $subpixel_order = SubPixelOrder::Default): void {}

	public function getSubpixelOrder(): SubPixelOrder {}

	public function setHintStyle(HintStyle $hint_style = HintStyle::Default): void {}

	public function getHintStyle(): HintStyle {}

	public function setHintMetrics(HintMetrics $hint_metrics = HintMetrics::Default): void {}
	...
	public function setColorMode(ColorMode $color_mode = ColorMode::Default): void {}

	public function getColorPalette(): int {}

	public function setColorPalette(int $palette = FontOptions::PALETTE_DEFAULT): void {}

	public function setCustomPaletteColor(int $colorId, float $red, float $green, float $blue, float $alpha): void {}

	/**
	 * @return array{red: float, green: float, blue: float, alpha: float}
	 */
	public function getCustomPaletteColor(int $colorId): array {}
#endif
}
